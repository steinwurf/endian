...
TEST(test_little_endian, convert)
{
    ...
    // Test 8-bit integer
    {
        ...
        endian::little_endian::put<endian::u8>(input, data);
        EXPECT_EQ(0x11U, data[0]);

        // No change will occur for a single-byte value
        uint8_t out = endian::little_endian::get<endian::u8>(data);
        EXPECT_EQ(out, input);
    }
    ...
    // Test 16-bit integer
    {
        ...
        endian::little_endian::put<endian::u16>(input, data);
        EXPECT_EQ(0x22U, data[0]);
        EXPECT_EQ(0x11U, data[1]);

        // Get should swap the value back (no change for big endian)
        uint16_t out = endian::little_endian::get<endian::u16>(data);
        EXPECT_EQ(out, input);
    }
    ...
    // Test 24-bit integer
    {
        ...
        // If the host is little endian, the put function
        // should change the byte order (no change for big endian)
        endian::little_endian::put<endian::u24>(input, data);
        EXPECT_EQ(0x33U, data[0]);
        EXPECT_EQ(0x22U, data[1]);
        EXPECT_EQ(0x11U, data[2]);

        // Get should swap the value back (no change for big endian)
        uint32_t out = endian::little_endian::get<endian::u24>(data);
        EXPECT_EQ(out, input);
    }
    ...
    // Test 32-bit integer
    {
        ...
        // If the host is little endian, the put function
        // should change the byte order (no change for big endian)
        endian::little_endian::put<endian::u32>(input, data);
        ...
        // Get should swap the value back (no change for big endian)
        uint32_t out = endian::little_endian::get<endian::u32>(data);
        EXPECT_EQ(out, input);
    }
    ...
    // Test 40-bit integer
    {
        ...
        // If the host is little endian, the put function
        // should change the byte order (no change for big endian)
        endian::little_endian::put<endian::u40>(input, data);
        ...
        // Get should swap the value back (no change for big endian)
        uint64_t out = endian::little_endian::get<endian::u40>(data);
        EXPECT_EQ(out, input);
    }
    ...
    // Test 48-bit integer
    {
        ...
        // If the host is little endian, the put function
        // should change the byte order (no change for big endian)
        endian::little_endian::put<endian::u48>(input, data);
        ...
        // Get should swap the value back (no change for big endian)
        uint64_t out = endian::little_endian::get<endian::u48>(data);
        EXPECT_EQ(out, input);
    }
    ...
    // Test 56-bit integer
    {
        ...
        // If the host is little endian, the put function
        // should change the byte order (no change for big endian)
        endian::little_endian::put<endian::u56>(input, data);
        ...
        // Get should swap the value back (no change for big endian)
        uint64_t out = endian::little_endian::get<endian::u56>(data);
        EXPECT_EQ(out, input);
    }
    ...
    // Test 64-bit integer
    {
        ...
        // If the host is little endian, the put function
        // should change the byte order (no change for big endian)
        endian::little_endian::put<endian::u64>(input, data);
        ...
        // Get should swap the value back (no change for big endian)
        uint64_t out = endian::little_endian::get<endian::u64>(data);
        EXPECT_EQ(out, input);
    }
}
